...
export const courses = [
  {
    ...
    subtitle: "Udemy, Instructor: Stephen Grider (2025)",
    icon: "diagram-3-fill",
    link: "https://kaizen.udemy.com/course/microfrontend-course",
    bullets: [
      "Microfrontends with React.js and Vue.js",
      "Module Federation",
      "CI/CD pipelines setup: production-style workflow",
    ],
  },
  {
